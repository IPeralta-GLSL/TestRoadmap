...
export const useMediaContainerStyles = makeStyles()((theme, { isAudio }) => ({
    wrapper: {
        position: 'relative',
        alignItems: 'center',
        display: 'flex',
...
export const useFilePlayerStyles = makeStyles()((_, { isAudio }) => ({
    wrapper: {
        aspectRatio: isAudio ? 'unset' : '16 / 9',
        width: '100%',
    },
}));
//# sourceMappingURL=useMediaContainerStyles.js.map