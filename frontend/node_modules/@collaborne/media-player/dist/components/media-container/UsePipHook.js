...
export const UsePipHook = ({ isPlayerReady }) => {
    const [getListener, isPlaying, setCurrentTime, hasPipTriggeredByClick, setHasPipTriggeredByClick, mediaContainerRef, reactPlayerRef, isPip, exitPip, requestPip,] = useMediaStore(state => [
        state.getListener,
        state.isPlaying,
    ...
    useMediaListener('timeupdate', e => (currentTimeRef.current = e.seconds), listener);
    ...
    const isVisible = intersectionObservable === null || intersectionObservable === void 0 ? void 0 : intersectionObservable.isIntersecting;
    ...
    useEffect(() => {
        ...
        const mediaEl = (_a = reactPlayerRef === null || reactPlayerRef === void 0 ? void 0 : reactPlayerRef.current) === null || _a === void 0 ? void 0 : _a.getInternalPlayer();
    ...
    useMediaListener('pipEnter', async () => {
        var _a;
        const mediaEl = (_a = reactPlayerRef === null || reactPlayerRef === void 0 ? void 0 : reactPlayerRef.current) === null || _a === void 0 ? void 0 : _a.getInternalPlayer();
        if (mediaEl) {
            mediaEl.currentTime = currentTimeRef.current;
            setCurrentTime === null || setCurrentTime === void 0 ? void 0 : setCurrentTime(currentTimeRef.current);
        }
    }, listener);
    return null;
};
//# sourceMappingURL=UsePipHook.js.map