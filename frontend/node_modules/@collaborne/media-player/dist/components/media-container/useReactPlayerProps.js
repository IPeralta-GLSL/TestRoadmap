...
export const useReactPlayerProps = () => {
    ...
    const [reactPlayerRef, playbackRate, initialState, isPlaying, isMuted, volume, emitter, setReady, setDuration, onProgress, isPip, getListener, setCurrentTime, hasStarted,] = useMediaStore(state => [
    ...
    const reactPlayerProps = {
        ...
        onReady: () => {
            emitter.emit('ready');
            if (!(readyFiredRef === null || readyFiredRef === void 0 ? void 0 : readyFiredRef.current)) {
...
//# sourceMappingURL=useReactPlayerProps.js.map