...
export const useMouseActivityHook = () => {
    const [lastMouseMove, setLastMouseMove] = useState(0);
    const [isContainerHovered, setIsContainerHovered] = useState(false);
    const [isFullscreen, setShowControls, isPlaying, isPip, showControls, mediaContainerRef, lastActivityRef, markActivity,] = useMediaStore(state => [
        state.isFullscreen,
    ...
    const updateShowControls = useCallback(() => {
        ...
        const lastActivity = (lastActivityRef === null || lastActivityRef === void 0 ? void 0 : lastActivityRef.current) || 0;
        if (!isPlaying) {
            return setShowControls(true);
        }
        if (isPip) {
    ...
    useEvent('focus', () => {
        markActivity();
        updateShowControls();
    }, mediaContainerRef === null || mediaContainerRef === void 0 ? void 0 : mediaContainerRef.current, { capture: true });
    return {
        onMouseEnter,
        onMouseLeave,
        onMouseMove,
...
//# sourceMappingURL=useMouseActivityHook.js.map