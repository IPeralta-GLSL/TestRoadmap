export const usePlaybackRateButtonHook = ({ currentRate, playbackRates, setPlaybackRate, }) => {
    const handleClick = () => {
        ...
        if (currentIndex === -1) {
            throw Error(`${currentRate} should belong to ${JSON.stringify(playbackRates)}`);
        }
...
//# sourceMappingURL=usePlaybackRateButtonHook.js.map