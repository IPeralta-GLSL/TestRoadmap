...
import { DEFAULT_EVENT_ANIMATION_DURATION, PAUSE_ANIMATION, } from '../../utils/constants';
 ...
 */
export const PauseAnimation = ({ animationDuration = DEFAULT_EVENT_ANIMATION_DURATION, className, }) => {
    ...
    return (_jsx(AnimatedIconWrapper, { durationMs: animationDuration, startAnimation: showPauseAnimation, className: className, "data-testid": PAUSE_ANIMATION, children: _jsx(PiPauseCircleFill, { className: centeredIcon }) }));
};
//# sourceMappingURL=PauseAnimation.js.map