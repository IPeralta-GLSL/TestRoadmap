...
export const usePipMouseActivityHook = () => {
    const [lastMouseMove, setLastMouseMove] = useState(0);
    const [isContainerHovered, setIsContainerHovered] = useState(false);
    const [setShowPipControls, isPlaying, showPipControls, lastPipActivityRef, markPipActivity, isPip,] = useMediaStore(state => [
    ...
    const updateShowControls = useCallback(() => {
        ...
        const lastActivity = (lastPipActivityRef === null || lastPipActivityRef === void 0 ? void 0 : lastPipActivityRef.current) || 0;
...
//# sourceMappingURL=usePipMouseActivity.js.map