...
import { MediaProviderProps } from '../context/MediaProvider';
import { MediaStore } from '../store/media-store';
export * from '@testing-library/react';
export { default as userEvent } from '@testing-library/user-event';
export type RenderResult = ReturnType<typeof renderWithProviders>;
export declare const renderWithProviders: (Component: ReactNode, options?: RenderOptions) => import("@testing-library/react").RenderResult<typeof import("@testing-library/dom/types/queries"), HTMLElement, HTMLElement>;
/** Setup test for a component that is dependant of the `MediaProvider` context */
export declare function setupMediaProvider(Component: ReactNode, mediaProviderProps?: Partial<MediaProviderProps>): {
