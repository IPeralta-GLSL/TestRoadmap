...
export const DEFAULT_MEDIA_STATE_SETTERS = {
    play: NO_OP,
    pause: NO_OP,
    mute: NO_OP,
    unmute: NO_OP,
...
export const DEFAULT_EXTERNAL_STATE_SETTERS = {
...
export const DEFAULT_MEDIA_STORE_CONTEXT = {
    ...DEFAULT_MEDIA_STATE,
