...
describe('colors', () => {
    ...
    describe('blend', () => {
        ...
        it('with intensify', () => {
            expect(blend(['#ff0000', '#0000ff'], { intensifyIndex: 0 })).toEqual('#95002bb8');
            expect(blend(['#ff0000', '#0000ff'], { intensifyIndex: 1 })).toEqual('#2a0095b8');
            expect(blend(['#ff0000', '#0000ff'], { intensifyAll: true })).toEqual('#490049d6');
        });
        it('with discount factor', () => {
            expect(blend(['#ff0000', '#0000ff'])).toEqual('#69006982');
            expect(blend(['#ff0000', '#0000ff'], {
                discountFactor: 0.5,
            })).toEqual('#75007547');
            expect(blend(['#ff0000', '#0000ff'], {
                intensifyIndex: 0,
