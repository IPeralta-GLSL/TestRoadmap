 ...
 * @category MediaStore
 */
export const useOnHoveredElement = ({ setShowControls, markActivity, }) => {
...
export const useOnHoveredControlElement = () => {
    const [setShowControls, markActivity] = useMediaStore(state => [state.setShowControls, state.markActivity], shallow);
...
export const useOnHoveredPipControlElement = () => {
    const [setShowControls, markActivity] = useMediaStore(state => [state.setShowPipControls, state.markPipActivity], shallow);
    return useOnHoveredElement({ markActivity, setShowControls });
};
//# sourceMappingURL=use-on-hovered-element.js.map